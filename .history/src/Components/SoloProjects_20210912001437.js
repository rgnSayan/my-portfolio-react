        ...
        <div className="soloProjects">
            ...
            <div className="soloProject__card">
                ...
                <Card className={classes.root}>
                    <CardActionArea>
                        ...
                        <CardContent>
                            ...
                            <div class="grid-container3">
                                <div class="item1">ReactJS</div>
                                <div class="item5">Firebase</div>
                                <div class="item6">Google-api</div>
                                <div class="item8">Material-UI</div>
                            </div>
                        </CardContent>
                    ...
                    <div className="card__button">
                        <a href="https://github.com/rgnSayan/google-Clone" target="_blank" rel="noreferrer">
                            <Button size="small" color="primary" variant="contained">
                                Source Code
                            </Button>
                        </a>
                        <a href="https://react-ce057.web.app/" target="_blank" rel="noreferrer">
                            <Button size="small" color="primary" variant="contained">
                                Live Demo
                            </Button>
                        </a>
